...
async def on_message(message):
  ...
  if message.content.startswith("케엔아"):
    ...
    #if query == "출첵":
        #await message.channel.send(f'{message.author.mention}님 2022-02-05일 출석체크 완료되었습니다')
    
    if query == "출첵":
        await message.channel.send('await message.channel.send("죄송합니다 ㅠㅠ 현재는 케엔봇이 업데이트중입니다 ㅠㅠ\n사유 : Railway 호스팅이 서버점검중...약 30분예상")')
